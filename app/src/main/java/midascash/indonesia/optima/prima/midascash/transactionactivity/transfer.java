...
import midascash.indonesia.optima.prima.midascash.fragment_transaction.fragment_transfer;
import midascash.indonesia.optima.prima.midascash.fragment_transaction.fragment_transferlist;
...
public class transfer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vpincome = (ViewPager) findViewById(R.id.viewpagertransfer);
        tabLayout = (TabLayout) findViewById(R.id.tabtransfer);
        adapter = new SimpleFragmentPagerAdapter(this, getSupportFragmentManager());

        save = (Button) findViewById(R.id.btnsavetransfer);
        cancel = findViewById(R.id.btncanceltransfer);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder dialog = new AlertDialog.Builder(transfer.this,R.style.AppCompatAlertDialogStyle)
                        .setTitle("Cancel")
    ...
    public class SimpleFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                return new fragment_transfer();
            } else {
                return new fragment_transferlist();
            }
        }
    ...
    public void onBackPressed() {
        ...
        transfer.this.overridePendingTransition(R.anim.trans_right_in,
