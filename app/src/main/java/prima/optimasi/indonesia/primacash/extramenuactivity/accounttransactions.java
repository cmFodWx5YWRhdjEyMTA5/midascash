...
import prima.optimasi.indonesia.primacash.formula.MyMarkerView;
...
public class accounttransactions extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final Double[] highest = {0.0d};
        final Double[] temphighest = {0.0d};

        temphighest[0] = generator.makedouble(bundle.getString("account_balance"));
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (DocumentSnapshot document : task.getResult()) {
                                ...
                                initial.setText(formatter.format(generator.makedouble(document.getData().get("account_balance").toString()))+ " " + document.getData().get("account_currency").toString());
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (DocumentSnapshot document : task.getResult()) {
                                ...
                                temphighest[0] = temphighest[0] + generator.makedouble(document.getData().get("income_amount").toString());

                                if(temphighest[0]> highest[0]){
                                    highest[0] = temphighest[0];
                                }
                                        ...
                                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                            if (task.isSuccessful()) {
                                                for (DocumentSnapshot document : task.getResult()) {
                                                    ...
                                                    temphighest[0] = temphighest[0] - generator.makedouble(document.getData().get("expense_amount").toString());
                                                            ...
                                                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                                if (task.isSuccessful()) {
                                                                    for (DocumentSnapshot document : task.getResult()) {
                                                                        ...
                                                                        temphighest[0] = temphighest[0] - generator.makedouble(document.getData().get("transfer_amount").toString());
                                                                                ...
                                                                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                                                    if (task.isSuccessful()) {
                                                                                        for (DocumentSnapshot document : task.getResult()) {
                                                                                            ...
                                                                                            temphighest[0] = temphighest[0] + generator.makedouble(document.getData().get("transfer_amount").toString())*generator.makedouble(document.getData().get("transfer_rate").toString());
